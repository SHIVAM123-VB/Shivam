...
class timthumb
{
	...
	protected function processImageAndWriteToCache($localImage)
	{
		...
		$new_width =  (int) abs((int) $this->param('w', 0));
		$new_height = (int) abs((int) $this->param('h', 0));
	...
	protected function openImage($mimeType, $src)
	{
		switch ($mimeType) {
			case 'image/jpeg':
				...
				$image = $this->fix_orientation($src, $image);
				break;
	...
	protected function fix_orientation($src, $image){
