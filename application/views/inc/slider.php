				...
				<div class="container-fluid">
					<div class="row">
								...
								<div class="tp-banner">
									<ul>
										...
										<li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
											<!-- MAIN IMAGE -->
											<img src="<?=base_url().'assets/front/img/theme/slider-img-1.jpg'?>" alt="slider" data-bgposition="center bottom" data-bgfit="cover"
											...
											<div class="tp-caption sfr tp-resizeme" data-x="left" data-hoffset="60" data-y="center"
												...
												data-endspeed="300"
												style="z-index: 6; font-size:50px; color:#0088cc; font-weight:800; white-space: nowrap;">3D
												Daydream View </div>
										...
										<li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
											<!-- MAIN IMAGE -->
											<img src="<?=base_url().'assets/front/img/theme/slider-img-2.jpg'?>" alt="slider" data-bgposition="center bottom" data-bgfit="cover"
												data-bgrepeat="no-repeat">
											...
											<div class="tp-caption sfr tp-resizeme" data-x="left" data-hoffset="60" data-y="center"
												...
												data-splitin="chars" data-splitout="none" data-elementdelay="0.03" data-endelementdelay="0.1"
												data-endspeed="300"
												style="z-index: 6; font-size:50px; color:#0088cc; font-weight:800; white-space: nowrap;">M75
												Sport Watch </div>
										...
										<li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
											<!-- MAIN IMAGE -->
											<img src="<?=base_url().'assets/front/img/theme/slider-img-3.jpg'?>" alt="slider" data-bgposition="center bottom" data-bgfit="cover"
												data-bgrepeat="no-repeat">
											...
											<div class="tp-caption sfr tp-resizeme" data-x="left" data-hoffset="60" data-y="center"
												...
												data-splitin="chars" data-splitout="none" data-elementdelay="0.03" data-endelementdelay="0.1"
												data-endspeed="300"
												style="z-index: 6; font-size:50px; color:#0088cc; font-weight:800; white-space: nowrap;">Flat
												SmartWatch </div>
						...
						<div class="col-md-3 no-padding">
							...
							<!-- New line required  -->
							<div class="product">
								<div class="like-bnr" style="background: #f5f5f5 url(<?=base_url().'assets/front/img/theme/slider-bnr.jpg'?>) right center no-repeat;">
							...
							<!-- Weekly Slaes  -->
							<div class="week-sale-bnr" style="background: url(<?=base_url().'assets/front/img/theme/week-sale-bg.jpg'?>) center center no-repeat;">
