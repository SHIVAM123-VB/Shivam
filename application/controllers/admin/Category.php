...
class category extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->faIconClass = "fa-list-alt";
		$this->filename = 'category';
		$this->defaultUrl = 'category';
		$this->labelSingular = 'category';
	...
	public function add()
	{
		...
		$pageData['title'] = "Add " . $this->filename;
		$pageData['faIconClass'] = $this->faIconClass;
		$this->load->view(SITE_ADMIN_DIR_NAME . "/" . $this->filename, ['pageData' => $pageData]);
	}
	...
	{
		$selectCols = "*";
		$searchableCols = array("id", "name", "icon", "status");
		$sortableCols = array(null,"id", "name",null, "status", null);
